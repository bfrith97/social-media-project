        ...
        <li class="comment-item">
            <div class="d-flex position-relative">
                <div class="avatar avatar-xs">
                    <a href="/profiles/${comment.user.id}"><img class="avatar-img rounded-circle" src="http://personator.nmxldev.com/photos/fake_sorted/${comment.user.picture}" alt=""></a>
                </div>
                <div class="ms-2">
                    <div class="bg-light rounded-start-top-0 p-2 rounded">
                        <div class="d-flex justify-content-between">
                            ...
                            <small class="ms-2">${comment.timeAgo}</small>
                        </div>
