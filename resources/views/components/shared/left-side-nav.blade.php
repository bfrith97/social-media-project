                ...
                <div class="card-body pt-0">
                    <div class="text-center">
                        ...
                        <div class="avatar avatar-lg mt-n5 mb-3">
                            <a href="{{ route('profiles.show', $user->id) }}"><img class="avatar-img rounded border border-white border-3" src="{{ $user->profile_picture ? asset($user->profile_picture) : ''}}" alt=""></a>
                        </div>
                        <!-- Info -->
