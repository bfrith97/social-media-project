                            ...
                            <div class="tab-pane fade show active" id="tab-1">
                                <div class="row g-4">
                                    <div class="col-sm-6 col-xl-4">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                <!-- Tag -->
                                                <a class="btn btn-xs btn-primary mt-n3" href="event-details.html">Spa
                                                    training </a>
                                                <h6 class="mt-3"><a href="event-details.html"> Bone thugs-n-harmony </a>
                                                </h6>
                                                <!-- Date time -->
                                                <p class="mb-0 small"><i class="bi bi-calendar-check pe-1"></i> Mon, Sep
                                                    25, 2020 at 9:30 AM </p>
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        ...
                                        <div class="card h-100">
                                            <div class="position-relative">
                                                <img class="img-fluid rounded-top" src="{{ asset('assets/images/events/02.jpg') }}" alt="">
                                                <div class="badge bg-danger text-white mt-2 me-2 position-absolute top-0 end-0">
                                                    Hotel
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                ...
                                                <a class="btn btn-xs btn-primary mt-n3" href="event-details.html">Photography
                                                    Workshop</a>
                                                <h6 class="mt-3"><a href="event-details.html"> Decibel magazine </a>
                                                </h6>
                                                <!-- Date time -->
                                                <p class="mb-0 small"><i class="bi bi-calendar-check pe-1"></i> Mon, Aug
                                                    10, 2022 at 9:30 AM </p>
                                                ...
                                                <ul class="avatar-group list-unstyled align-items-center mb-0">
                                                    ...
                                                    <li class="avatar avatar-xs">
                                                        <div class="avatar-img rounded-circle bg-primary">
                                                            <span class="smaller text-white position-absolute top-50 start-50 translate-middle">+34</span>
                                                        </div>
                                                    </li>
                                                    <li class="ms-3">
                                                        <small> are attending</small>
                                                ...
                                                <div class="d-flex mt-3 justify-content-between">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <label class="btn btn-sm btn-outline-success d-block" for="Interested2"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                            Interested</label>
                                                    </div>
                                                    <div class="dropdown ms-3">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                ...
                                                <h6 class="mt-3"><a href="event-details.html"> Illenium: fallen embers
                                                        tour </a></h6>
                                                <!-- Date time -->
                                                <p class="mb-0 small"><i class="bi bi-calendar-check pe-1"></i> Sun, Sep
                                                    23, 2022 at 12:00 PM </p>
                                                ...
                                                <ul class="avatar-group list-unstyled align-items-center mb-0">
                                                    ...
                                                    <li class="avatar avatar-xs">
                                                        <div class="avatar-img rounded-circle bg-primary">
                                                            <span class="smaller text-white position-absolute top-50 start-50 translate-middle">+65</span>
                                                        </div>
                                                    </li>
                                                    <li class="ms-3">
                                                        <small> are attending</small>
                                                ...
                                                <div class="d-flex mt-3 justify-content-between">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <label class="btn btn-sm btn-outline-success d-block" for="Interested3"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                            Interested</label>
                                                    </div>
                                                    <div class="dropdown ms-3">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                ...
                                                <a class="btn btn-xs btn-primary mt-n3" href="event-details.html">Live
                                                    show</a>
                                                <h6 class="mt-3"><a href="event-details.html"> Comedy on the green </a>
                                                </h6>
                                                <!-- Date time -->
                                                ...
                                                <ul class="avatar-group list-unstyled align-items-center mb-0">
                                                    ...
                                                    <li class="avatar avatar-xs">
                                                        <div class="avatar-img rounded-circle bg-primary">
                                                            <span class="smaller text-white position-absolute top-50 start-50 translate-middle">+56</span>
                                                        </div>
                                                    </li>
                                                    <li class="ms-3">
                                                        <small> are attending</small>
                                                ...
                                                <div class="d-flex mt-3 justify-content-between">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <label class="btn btn-sm btn-outline-success d-block" for="Interested4"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                            Interested</label>
                                                    </div>
                                                    <div class="dropdown ms-3">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                ...
                                                <ul class="avatar-group list-unstyled align-items-center mb-0">
                                                    ...
                                                    <li class="avatar avatar-xs">
                                                        <div class="avatar-img rounded-circle bg-primary">
                                                            <span class="smaller text-white position-absolute top-50 start-50 translate-middle">+36</span>
                                                        </div>
                                                    </li>
                                                    <li class="ms-3">
                                                        <small> are attending</small>
                                                ...
                                                <div class="d-flex mt-3 justify-content-between">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <label class="btn btn-sm btn-outline-success d-block" for="Interested5"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                            Interested</label>
                                                    </div>
                                                    <div class="dropdown ms-3">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                ...
                                                <ul class="avatar-group list-unstyled align-items-center mb-0">
                                                    ...
                                                    <li class="avatar avatar-xs">
                                                        <div class="avatar-img rounded-circle bg-primary">
                                                            <span class="smaller text-white position-absolute top-50 start-50 translate-middle">+46</span>
                                                        </div>
                                                    </li>
                                                    <li class="ms-3">
                                                        <small> are attending</small>
                                                ...
                                                <div class="d-flex mt-3 justify-content-between">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <label class="btn btn-sm btn-outline-success d-block" for="Interested9"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                            Interested</label>
                                                    </div>
                                                    <div class="dropdown ms-3">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body position-relative pt-0">
                                                ...
                                                <a class="btn btn-xs btn-primary mt-n3" href="event-details.html">Live
                                                    show</a>
                                                <h6 class="mt-3"><a href="event-details.html"> Lewis black tickets </a>
                                                </h6>
                                                <!-- Date time -->
                                                <p class="mb-0 small"><i class="bi bi-calendar-check pe-1"></i> Fri, Oct
                                                    05, 2022 at 1:00 AM </p>
                                                ...
                                                <ul class="avatar-group list-unstyled align-items-center mb-0">
                                                    ...
                                                    <li class="avatar avatar-xs">
                                                        <div class="avatar-img rounded-circle bg-primary">
                                                            <span class="smaller text-white position-absolute top-50 start-50 translate-middle">+75</span>
                                                        </div>
                                                    </li>
                                                    <li class="ms-3">
                                                        <small> are attending</small>
                                                ...
                                                <div class="d-flex mt-3 justify-content-between">
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <label class="btn btn-sm btn-outline-success d-block" for="Interested10"><i class="fa-solid fa-thumbs-up me-1"></i>
                                                            Interested</label>
                                                    </div>
                                                    <div class="dropdown ms-3">
