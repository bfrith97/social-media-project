        ...
        <div class="bg-mode p-4">
          ...
          <div class="card bg-transparent border-0">
            <div class="row g-3">
              <div class="col-4">
                <!-- Blog image -->
                <img class="rounded" src="assets/images/post/4by3/05.jpg" alt="">
              </div>
              <div class="col-8">
                <!-- Blog caption -->
                <a href="#" class="badge bg-success bg-opacity-10 text-success mb-2 fw-bold">Business</a>
                <h5><a href="blog-details.html" class="btn-link stretched-link text-reset fw-bold">Google shares top search trends of 2022</a></h5>
                <div class="d-none d-sm-inline-block">
                  <p class="mb-2">I think on style child of. Servants moreover in sensible it ye possible six say his. </p>
                  <!-- BLog date -->
                  <a class="small text-secondary" href="#!"> <i class="bi bi-calendar-date pe-1"></i> Jun 17, 2022</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card bg-transparent border-0">
            <div class="row g-3">
              <div class="col-4">
                <!-- Blog image -->
                <img class="rounded" src="assets/images/post/4by3/06.jpg" alt="">
              </div>
              <div class="col-8">
                <!-- Blog caption -->
                <a href="#" class="badge bg-warning bg-opacity-10 text-warning mb-2 fw-bold">Technology</a>
                <h5><a href="blog-details.html" class="btn-link stretched-link text-reset fw-bold">Counts reels replies, delivering another way to tap into the video</a></h5>
                <div class="d-none d-sm-inline-block">
                  <p class="mb-2">Placing forming nay looking old married few has. Margaret disposed of add screened rendered. </p>
                  <!-- BLog date -->
                  <a class="small text-secondary" href="#!"> <i class="bi bi-calendar-date pe-1"></i> Nov 11, 2022</a>
                </div>
              </div>
            </div>
          </div>
