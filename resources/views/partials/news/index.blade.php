                    ...
                    <div class="card bg-transparent border-0">
                        <div class="row g-3">
                            ...
                            <div class="col-8">
                                ...
                                <div class="d-none d-sm-inline-block">
                                    <p class="mb-2">Under folly balls, death own point now men. Match way these she
                                        avoids seeing death.</p>
                                    <!-- BLog date -->
                                    <a class="small text-secondary" href="#!"> <i class="bi bi-calendar-date pe-1"></i>
                                        Mar 07, 2022</a>
                                </div>
                    ...
                    <div class="card bg-transparent border-0">
                        <div class="row g-3">
                            ...
                            <div class="col-8">
                                ...
                                <div class="d-none d-sm-inline-block">
                                    <p class="mb-2">I think on style child of. Servants moreover in sensible it ye
                                        possible six say his. </p>
                                    <!-- BLog date -->
                                    <a class="small text-secondary" href="#!"> <i class="bi bi-calendar-date pe-1"></i>
                                        Jun 17, 2022</a>
                                </div>
                    ...
                    <div class="card bg-transparent border-0">
                        <div class="row g-3">
                            ...
                            <div class="col-8">
                                ...
                                <div class="d-none d-sm-inline-block">
                                    <p class="mb-2">Placing forming nay looking old married few has. Margaret disposed
                                        of add screened rendered. </p>
                                    <!-- BLog date -->
                                    <a class="small text-secondary" href="#!"> <i class="bi bi-calendar-date pe-1"></i>
                                        Nov 11, 2022</a>
                                </div>
